...
## YoloV8 with the TensorRT framework for JetPack 6.2.* <br/>
Based on: https://github.com/Qengineering/YoloV8-TensorRT-Jetson_Nano <br/>
...
$ mkdir *MyDir*
$ cd *MyDir* 
$ git clone --depth=1 https://github.com/inaciose/YoloV8-TensorRT-Jetson-Orin.git
```
